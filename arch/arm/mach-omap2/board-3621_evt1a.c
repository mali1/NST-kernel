...
static struct platform_device *boxer_gpio_devices_evt1[] __initdata = {
	&boxer_keys_gpio_evt1,
};

static struct platform_device *boxer_gpio_devices_evt2[] __initdata = {
	&boxer_keys_gpio,
};
...
l3_rate_table = cpu_is_omap3622() ? omap3630_l3_rate_table
...
//	ldp_flash_init();
    ...
    if (is_encore_3g()) {
        printk("Encore 3G, initializing usb ehci\n");
        usb_ehci_init();
    }
#endif
#if defined(CONFIG_USB_ANDROID) || defined(CONFIG_USB_ANDROID_MODULE)
